...
export default function Navbar({ user }: { user: any }) {
  ...
  return (
    <Disclosure as="nav" className=" shadow-sm" style={{backgroundColor: '#191F59'}}>
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between">
              <div className="flex">
                ...
                <Image
                src={'https://ucarecdn.com/4c781150-fca0-4151-ba4e-3d3ae8186258/tiraLogo.png'}
                height={50}
                style={{marginLeft: 10}}
                width={70}
                alt={`Tira Crest`}
              />
                {/* <svg width="33" height="32" viewBox="0 0 240 255" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M195.752 170.2V197H103.152V58.4H134.352V170.2H195.752Z" fill="#191F59"/>
                  </g>
                  <defs>
